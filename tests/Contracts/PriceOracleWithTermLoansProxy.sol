...
import "../../contracts/CErc20WithTermLoans.sol";
import "../../contracts/CTokenWithTermLoans.sol";
...
contract PriceOracleWithTermLoansProxy is PriceOracleWithTermLoans {
    ...
    function getUnderlyingPrice(CTokenWithTermLoans cToken) public view returns (uint) {
        ...
        address underlying = CErc20WithTermLoans(cTokenAddress).underlying();
