...
import "../../contracts/ComptrollerWithTermLoansInterface.sol";
...
contract BoolComptrollerWithTermLoans is ComptrollerWithTermLoansInterface {
    bool allowMint = true;
    bool allowRedeem = true;
    bool allowBorrow = true;
    bool allowRepayBorrow = true;
    ...
    function repayBorrowAllowed(
        ...
        address _borrower,
        uint _repayAmount,
        uint _loanIndex) public returns (uint) {
        _cToken;
        _payer;
        _borrower;
        _repayAmount;
