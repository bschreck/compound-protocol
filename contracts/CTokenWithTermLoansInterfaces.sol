...
contract CTokenWIthTermLoansStorage {
     ...
     */
    ComptrollerWithTermLoansInterface public comptroller; // MODIFIED
...
contract CTokenWithTermLoansInterface is CTokenWIthTermLoansStorage {
     ...
     */
    event Borrow(address borrower, uint borrowAmount, uint loanIndex, uint deadline, uint accountBorrows, uint totalBorrows); // MODIFIED

    /**
     * @notice Event emitted when a borrow is repaid
     */
    event RepayBorrow(address payer, address borrower, uint loanIndex, uint repayAmount, uint accountBorrows, uint totalBorrows); // MODIFIED

    /**
     * @notice Event emitted when a borrow is liquidated
     */
    event LiquidateBorrow(address liquidator, address borrower, uint repayAmount, uint loanIndex, address cTokenCollateral, uint seizeTokens); // MODIFIED
     ...
     */
    event NewComptroller(ComptrollerWithTermLoansInterface oldComptroller, ComptrollerWithTermLoansInterface newComptroller); // MODIFIED
