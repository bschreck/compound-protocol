 ...
 * @author Compound
 */
contract CErc20WithTermLoansDelegator is CTokenWithTermLoansInterface, CErc20WithTermLoansInterface, CDelegatorInterface {
    /**
    ...
    constructor(address underlying_,
                ComptrollerWithTermLoansInterface comptroller_, // MODIFIED
     ...
     * @return uint 0=success, otherwise a failure (see ErrorReporter.sol for details)
     */
    function liquidateBorrow(address borrower, uint repayAmount, uint loanIndex, CTokenWithTermLoansInterface cTokenCollateral) external returns (uint) {
